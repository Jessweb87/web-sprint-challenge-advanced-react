...
- A stateful component render depends upon the value of the state. A functional component is always a stateless component.

2. When does a componentWillMount function be called? What about a componentWillUpdate?
- A componentWillMount is called before the render method is executed. 
    -A componentWillUpdate() is called every time a re-render

3. Define stateful logic.
- Stateful logic is any code that uses the state.r is required.
